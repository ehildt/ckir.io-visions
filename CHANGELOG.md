...
- 36adb77: - CI/CD: consolidated the release workflow — removed the standalone `release.ci.yml` and deduplicated `ci.yml` / `non-release.ci.yml` (single root install + per-workspace verification).
