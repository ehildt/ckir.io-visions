...
- The macro-taxonomy routes a fact into its family hierarchy (partition lane only), top-down: CLUSTER → COMMUNITY → HUB → NODE (the NODE is the stored record itself — never named):
  ...
  - community (COMMUNITY): ONE lowercase PLURAL sub-family narrowing the category ("survival games" under "games", "tv shows" under "shows"); omit when no sub-family applies.
  ...
  A category or community is NEVER a specific entity, product, company, or game title: "amd" is a subject under the category "stocks"; "stellar blade" is a subject under the category "games"; a show/work title like "breaking-bad" is a tag or hub, never a community. Always include category; reuse the existing labels whenever they fit.
- PERSONA & FICTION CONTENT (absolute): content about an adopted persona, a roleplay, or a fictional/entertainment work routes by its real-world MEDIUM, never by in-universe domains — a TV persona's biography, family, or career belongs under the medium family (category "shows", community "tv shows", hub the show's title or the persona name); never "family", "education", "business", or "science" for invented content.
